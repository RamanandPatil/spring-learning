package learning.spring.core.javaconfig.di.si.coach;
 ...
 * Setter Injection with Java Config without ComponentScan.
...
public class TennisCoach implements Coach {
    ...
    public void setFortuneService(FortuneService fortuneService) {
        System.out.println("TennisCoach.setFortuneService() Setter Injection "
                           + "with Java config");
